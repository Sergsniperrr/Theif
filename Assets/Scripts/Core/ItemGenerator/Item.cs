...
public class Item : MonoBehaviour
{
  ...
  private void OnEnable() => InteractButton.onClick.AddListener(OnButtonClick);

  private void OnDisable() => InteractButton.onClick.RemoveListener(OnButtonClick);
  ...
  private void OnTriggerStay(Collider collider)
  {
             ...
             Vector3.Distance(transform.position, player1.transform.position) > _distance)
    {
      ...
      if (_slider != null)
      {
        ...
        // player1.PlayerNoise.MakeIsInactiveAction();
        // player1.PlayerNoise.ChangeColliderRadius(Constant.BaseRadiusPlayerCollider);
        // player1.PlayerNoise.ChangeScale(Constant.StandartNoiseSize);
        _fillAnimation.Kill();
      }
    }
  }
  ...
  private void FillToSlider()
  {
    ...
    _fillAnimation = _slider.DOFillAmount(MaximumValueSlider, Constant.SliderMultiplier * Weight).SetEase(Ease.Linear)
      .OnComplete((() =>
      {
